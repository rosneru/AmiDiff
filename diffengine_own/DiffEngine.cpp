                      ...
                      DiffFilePartition& p_File2Diff)
{
  ...
  while(i < p_File1Src.NumberOfLines())
  {
    ...
    else
    {
      ...
      if (p_File2Src.MatchLine(nLineF2, p_File1Src, /*out*/nLineF1) )
      {
      ...
      else
      {
        ...
        nF2CurrentLine++; // next line in p_File2Src
      }
    }
