...
Application::Application(ScreenBase& screen, 
  ...
  : m_Screen(screen),
    ...
    m_TextFinder(m_DiffWorker, m_DiffWindow),
    ...
    m_CmdNavNextDiff(&m_AllWindowsList, m_DiffWorker, m_DiffWindow),
    m_CmdNavPrevDiff(&m_AllWindowsList, m_DiffWorker, m_DiffWindow),
